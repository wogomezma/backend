...
class ViewsRoutes {
  ...
  initViewsRoutes() {
    this.router.get(`${this.path}/`, this.viewsController.getLoginView);
    this.router.get(`${this.path}/login`, this.viewsController.getLoginView);
    this.router.get(`${this.path}/register`, this.viewsController.getRegisterView);
    this.router.get(`${this.path}/profile`, handlePolicies(["user", "admin", "premium"]), this.viewsController.getProfileView);
    this.router.get(`${this.path}/products`, handlePolicies(["user", "premium"]), this.viewsController.getProductsView);
    this.router.get(`${this.path}/products/:cid/:pid`, handlePolicies(["user", "premium"]), this.viewsController.addProductToCart);
    this.router.get(`${this.path}/carts`, handlePolicies(["user", "admin", "premium"]), this.viewsController.getCartsView);
    this.router.get(`${this.path}/carts/:cartsId`, handlePolicies(["user", "premium"]), this.viewsController.getCartDetailsView);
    this.router.get(`${this.path}/recover`, handlePolicies(["public"]), this.viewsController.getRecoverView);
    this.router.get(`${this.path}/documents/:uid`, this.viewsController.getDocumentsView);
    this.router.get(`${this.path}/useradmin`, handlePolicies(["admin"]), this.viewsController.getUserAdminView);
    this.router.get(`${this.path}/sendrecovery`, handlePolicies(["public"]), this.viewsController.getSendRecoveryView);
  }
}
